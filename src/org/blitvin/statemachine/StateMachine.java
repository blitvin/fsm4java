 ...
 * See also {@link StateMachineInitializer} 
 * 
 * @author blitvin
 *
 * @param <EventType> state machine's alphabet
 */
public class StateMachine<EventType extends Enum<EventType>> {
	 ...
	 */
	public StateMachine(Map<String, State<EventType>> states,State<EventType> initialState) throws BadStateMachineSpecification{
		this.states = states;
	 ...
	 * @throws BadStateMachineSpecification
	 */
	public StateMachine(Map<String, State<EventType>> states,State<EventType> initialState,
			StateMachineInitializer<EventType> initializer) throws BadStateMachineSpecification {
		this(states,initialState);
		comepleteInitialization(initializer);
	}
	...
	public void comepleteInitialization(StateMachineInitializer<EventType> initializer) throws BadStateMachineSpecification {
		...
		for(State<EventType> curState : states.values()){
			HashMap<EventType, Map<String, String>> map =initializer.getProperties4StateTransitions(curState.getStateName());
